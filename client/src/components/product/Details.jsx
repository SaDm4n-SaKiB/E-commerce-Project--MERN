                ...
                <div className="container mt-2">
                    <div className="row">
                        ...
                        <div className="col-md-5 p-3">
                            ...
                            <p className="bodySmal mb-2 mt-1">Description: {Details[0]["shortDes"]}</p>
                            {
                                Details[0]["discount"]?(
                                    <span className="bodyXLarge">Price: <strike className="text-secondary">{Details[0]["price"]}</strike> {Details[0]["discountPrice"]} </span>
                                ):(
                                    <span className="text-secondary bodyXLarge">Price: {Details[0]["price"]} </span>
                                )
                            }
                            <div className="row">
                                ...
                                <div className="col-4 p-2">
                                    ...
                                    <div className="input-group my-2">
                                        <button  onClick={(async ()=>decrementQuantity())} className="btn btn-outline-secondary">-</button>
                                        <input value={quantity} type="text" className="form-control bg-light text-center" readOnly/>
                                        <button  onClick={(async ()=>incrementQuantity())} className="btn btn-outline-secondary">+</button>
                                    </div>
                                </div>
                                <div className="col-4 p-2">
                    ...
                    <div className="row mt-3">
                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                            <li className="nav-item" role="presentation">
                                <a className="nav-link active" id="Speci-tab" data-bs-toggle="tab" href="#Speci-tabpane"
                                 type="button" role="tab" aria-controls="Speci-tabpane" aria-selected="true">Specifications</a>
                            </li>
                            <li className="nav-item" role="presentation">
                                <a className="nav-link" id="Review-tab" data-bs-toggle="tab" href="#Review-tab-pane" type="button" 
                                role="tab" aria-controls="Review-tab-pane" aria-selected="false">Review</a>
                            </li>
                        </ul>
                        <div className="tab-content" id="myTabContent">
                            <div className="tab-pane fade show active" id="Speci-tabpane" role="tabpanel" aria-labelledby="Speci-tab" >
                                {
