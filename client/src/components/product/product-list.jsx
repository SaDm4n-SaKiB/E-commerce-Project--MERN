            ...
            <div className="row">
                <div className="col-md-3 p-2">
                    <div className="card vh-100 p-3 shadow-sm">
                        <label htmlFor="brands" className="form-label mt-3">Brands</label>
                        <select value={Filter.brandID} onChange={async (e)=>{await inputOnChange('brandID',e.target.value)}} name="" id="" className="form-control form-select">
                        ...
                        <select value={Filter.categoryID} onChange={async (e)=>{await inputOnChange('categoryID',e.target.value)}} name="" id="" className="form-control form-select">
                        ...
                        <label htmlFor="" className="form-label mt-3">Maxium Price ${Filter.priceMax}</label>
                        ...
                        <label htmlFor="" className="form-label mt-3">Minimum Price ${Filter.priceMin}</label>
