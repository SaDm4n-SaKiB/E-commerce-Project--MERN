                        ...
                        <div className="card p-4">
                                            ...
                                            <li className="listgroup-item d-flex justify-content-between align-items-start">
                                                ...
                                                <div className="ms-2 me-auto">
                                                    ...
                                                    <p className="fw-lighter my-1">
                                                        Unit Price: {price},Qty: {item['qty']}, Size: {item['size']},
                                                        Color: {item['color']}
                                                    </p>
                            ...
                            <div className="my-4">
                                <ul className="list-group bg-transparent list-group-flush">
                                    ...
                                    <li className="list-group-item bg-transparent h6 m-0 text-dark"><span
                                        className="float-end"> Vat(5%): <i className="bi bi-currency-dollar"/>{CartVatTotal}</span>
                                    </li>
                                    <li className="list-group-item bg-transparent h6 m-0 text-dark"><span
                                        className="float-end"> Payable: <i
