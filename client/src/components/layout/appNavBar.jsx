...
const AppNavBar = () => {
    ...
    const {CartCount,CartListRequest,InvoiceCount,InvoiceListRequest}=CartStore();
    ...
    const onLogout=async ()=>{
        ...
        localStorage.clear();
        navigate("/");
        window.location.reload(); // Reaload Home page
    }
                    ...
                    <div className="d-lg-flex">
                        <div className="input-group">
                            ...
                            <Link to={SearchKeyword.length>0?(`/by-keyword/${SearchKeyword}`):(`/`)} className="btn btn-outline-dark" type="submit">
                                <svg  xmlns="http://www.w3.org/200/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{width:24, height:24}}>
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                                </svg>
                            </Link>
                        </div>
                        <Link to="/cart" type="button" className="btn mx-2 btn-light position-relative">
                        ...
                        <Link to="/wish" type="button" className="btn mx-2 btn-light position-relative">
...

                        {
                            isLogin()?(
                                <>
                                    <Link to="/orders" type="button" className="btn mx-2 btn-light position-relative">
